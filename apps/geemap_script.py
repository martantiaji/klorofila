...
#Read the Data
col= ee.ImageCollection("LANDSAT/LC08/C01/T1_SR")             .filterBounds(studyarea)
...
clh_collection =  ee.ImageCollection.fromImages(year_list.map(func_miw
).flatten())
...
for i in range(i=2013, i<=2020, 1):
