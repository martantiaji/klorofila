...
def app():
    ...
    st.markdown(
        ...
        Aplikasi web ini dibuat berdasarkan script [streamlit](https://github.com/martantiaji/klorofila.git) dan script yang telah dibuat pada [Google Earth engine](https://code.earthengine.google.com/ae953cd084934e4cdd262a6ca9bc01f5)
